...
public class ConstNpc {
    ...
    public static final String TRONGDUAHAU = "|7|Thêm Đủ Nước Và Phân Bón Để Bắt Đầu Trồng\n"
            + "|7|Để Trồng Dưa Hấu Chúng Ta Cần\n"
            + "|7|1 Hạt Giống, 1 Thuốc tăng trưởng, 1 Phân Bón";
    ...
    public static final int CONFIRM_OPEN_INTRINSIC_MAX = 518;
    ...
    // Shenron credit: Ryo#
    public static final int SUMMON_SHENRON_SUPER = 928;
    public static final int SUMMON_SHENRON_NOEL = 929;
    public static final int SUMMON_SHENRON_HALLOWEEN = 930;
    ...
    public static final int SHENRON_1_3 = 506;
    ...
    //index menu dua hau
    public static final int CHUA_THE_THU_HOACH = 500;
    public static final int CO_THE_THU_HOACH = 501;
    public static final int CO_THE_THU = 501;
    ...
    public static final int HOC_TUYET_KY = 9990;
    public static final int SACH_TUYET_KY = 99980;
    public static final int DONG_THANH_SACH_CU = 19787;
    public static final int DOI_SACH_TUYET_KY = 28777;
    public static final int CHE_TAO_TRANG_BI_THIEN_SU = 188877;
    public static final int CAPSULE_KICH_HOAT = 1655;
    public static final int VE_TANG_NGOC = 718;
    public static final int DANG_SINH_LE = 197882;
    public static final int DANG_SINH_LE_VIP = 197827;

    // index ly_tieu_nuong
    public static final int CON_SO_MAY_MAN_VANG = 500;
    ...
    public static final int KEO_BUA_BAO_CUSTOM_BET = 2828509;
    public static final int UPDATE_CHON_AI_DAY_NGOC = 509;
    public static final int MENU_NANG_GIOI_HAN = 1001;
    public static final int QUEST_CHA_GIO = 838282;
    public static final int QUEST_CHA_GIO1 = 938282;
    public static final int TALK_MENU = 977723;
    public static final int MAY_DAM = 977883;
    public static final int PHAO_BONG = 9778839;
    public static final int PHAO_BONG_VIP = 9778683;
    public static final int GOKU_DAY = 977183;
    public static final int MENU_OPEN_MMB_WITH_JAR = 1001;
    public static final int MENU_OPEN_MMB_NO_JAR = 1002;
    public static final int MENU_NOT_OPEN_MMB_WITH_JAR = 1003;
